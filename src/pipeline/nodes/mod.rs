...
// pub trait Node<const NUM_IN: usize, I, O> {
//     /// Readable name
//     fn name(&self) -> &str;

//     /// Mutable [Receiver] handle
//     fn receiver(&mut self, port_index: usize) -> &mut Receiver<I>;
...
//     fn run(&mut self) {
//         let mut input_port_index = NUM_IN;

//         loop {
//             if input_port_index == NUM_IN {
//                 input_port_index = 0;
//             } else {
//                 input_port_index += 1;
//             }

//             match self.receiver(input_port_index).recv() {
//                 Ok(value) => {
...
// pub struct Node<const IN: usize, const OUT: usize, I, O>{
//     /// RX port(s)
//     rx_ports: [Receiver<I>; IN],

//     /// TX port
//     tx_port: [Sender<O>; OUT],
// }
...
//         ctx.load_gzip_rinex_file("data/CRNX/V3/MOJN00DNK_R_20201770000_01D_30S_MO.crx.gz").unwrap();
